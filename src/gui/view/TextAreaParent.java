...
/**
 * 
 * Abstract class generating a VBox containing a Label prompting user to do
 * something, a TextArea in which the author can enter text, and a Button that
 * can perform any defined action game's description
 * 
 * @author Stephen
 *
 */
...
public abstract class TextAreaParent extends EditingElementParent {
	 ...
	 * 
	 * @param insets
	 *            indicating the desired padding
	 */
