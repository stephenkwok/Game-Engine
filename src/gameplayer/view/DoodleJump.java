...
public class DoodleJump extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        player.addRule(new Rule(new BottomCollision(player,greenplatform,true),new ShiftScene(level1,"Down",40.0)));
        player.addRule(new Rule(new BottomCollision(player,greenplatform,true),new CreateActor(player,greenplatform,100.0,800.0,400.0,400.0)));
