...
public class TopDownShooter extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        player2.addRule(new Rule(new KeyTrigger(KeyCode.COMMAND), new Spawn(player2,bullet,70.0)));
        player2.addRule(new Rule(new KeyTrigger(KeyCode.COMMAND), new Spawn(player2,bullet,110.0)));
        ...
        player1.addRule(new Rule(new TopCollision(player1,enemy), new Destroy(player1)));
        
        player2.addRule(new Rule(new TopCollision(player2,enemy), new Destroy(player2)));
