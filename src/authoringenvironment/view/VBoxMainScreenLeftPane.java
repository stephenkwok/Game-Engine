...
public class VBoxMainScreenLeftPane extends VBox {
	...
	private TextFieldGameNameEditor nameEditor;
	...
	private void initGameDescriptionEditor() {
		...
		gameDescriptionEditor = new TextAreaGameDescriptionEditor(prompt, buttonText, TEXT_AREA_ROWS, saveDescriptionButtonAction);
	}
